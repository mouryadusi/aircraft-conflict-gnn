"""
Script 6: Weather correlation exploratory analysis (secondary, not primary research).
Run: python scripts/06_weather_analysis.py
Input: data/raw/weather/*.csv, processed_data/labelled_large.csv, processed_data/region_final.pkl
Output: processed_data/labelled_with_weather.csv
"""
import pandas as pd
import numpy as np

# --- Step 1: Load and combine weather ---
...
# --- Step 3: Nearest-station, nearest-time join ---
...
print("\nSaved processed_data/labelled_with_weather.csv")
